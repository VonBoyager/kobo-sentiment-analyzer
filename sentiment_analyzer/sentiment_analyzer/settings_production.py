...
CSRF_TRUSTED_ORIGINS = config('CSRF_TRUSTED_ORIGINS', default='http://localhost,http://127.0.0.1,http://152.42.220.146,http://koboba.duckdns.org', cast=Csv() if USE_DECOUPLE else list)
