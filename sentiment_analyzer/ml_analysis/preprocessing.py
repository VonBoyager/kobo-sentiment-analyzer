...
def _ensure_nltk_data():
    ...
    # punkt_tab is optional - newer NLTK versions may not need it
    try:
        ...
        try:
            ...
            logger.warning(f"Could not download punkt_tab (optional): {e}")
    ...
    try:
        ...
        try:
            ...
            logger.warning(f"Could not download omw-1.4: {e}")
